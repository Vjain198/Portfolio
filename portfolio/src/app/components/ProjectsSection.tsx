      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <a
                  ...
                  className="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md mr-2 transition-colors"
                  target="_blank"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2">Truemeds India</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Built a full-featured website with React.js , Next.js and
                TypeScript, including product listing, shopping cart
                functionality, and state management using Redux.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs px-2 py-1 rounded">
                  React
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2">Lybrate</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Built a full-functional responsive website with React.js ,
                Next.js and including product listing, shopping cart
                functionality, and state management using Redux.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs px-2 py-1 rounded">
